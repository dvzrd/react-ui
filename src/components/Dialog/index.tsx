...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay ref={ref} className={dialogOverlay({ className })} {...props} />
));
...
>(({ className, children, ...props }, ref) => {
  const { content, close, icon } = dialogContent();
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title ref={ref} className={dialogTitle({ className })} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={dialogDescription({ className })} {...props} />
));
